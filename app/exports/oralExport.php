...
class OralExport implements FromQuery, WithHeadings, ShouldAutoSize
{
    use Exportable;
    ...
    public function query()
    {
        if ($this->option_id == 0) {
            return Candidat::query()
                ...
                ->select('candidats.identifiant', 'options.nom', 'candidats.nom as cdt_nom', 'candidats.prenoms', 'candidats.contact', 'inscriptions.oral')
