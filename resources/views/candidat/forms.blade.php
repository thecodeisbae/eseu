    ...
    <div class="card bg-warning text-black mb-4">
        <div class="card-body" style="margin:10px;">
            ...
            <div class="form-group row">
                ...
                <input class="form-control @error('nom') is-invalid @enderror my-2" name="nom" id="nom" type="text" value="{{ old('value') ?? ( $obj->nom ?? '' ) }}" />
                @error('nom')
            ...
            <div class="form-group row">
                ...
                <input class="form-control @error('prenom') is-invalid @enderror my-2" name="prenom" id="prenom" type="text" value="{{ old('value') ?? ( $obj->prenoms ?? '' ) }}" />
                @error('prenom')
                    <div class="invalid-feedback">
                        {{ $errors->first('prenom') }}
                    </div>
            ...
            <div class="form-group row">
                ...
                <select class="custom-select my-2 @error('sexe')  is-invalid @enderror" name="sexe" id="sexe">
            ...
            <div class="form-group row">
                ...
                <input class="form-control @error('date') is-invalid @enderror my-2" name="date" id="date" type="date" value="{{ old('value') ?? ( $obj->date_naissance ?? '' ) }}" />
                @error('date')
                    <div class="invalid-feedback">
                        {{ $errors->first('date') }}
                    </div>
            ...
            <div class="form-group row">
                ...
                <input class="form-control my-2" name="lieu" id="lieu" type="text" value="{{ old('value') ?? ( $obj->lieu_naissance ?? '' ) }}" />
            </div>
            <div class="form-group row">
                <label class="small mb-1" for="login">Adresse<span class="text-danger" style="font-size:20px;">&nbsp;</span></label>
                <input class="form-control my-2" name="adresse" id="adresse" type="text" value="{{ old('value') ?? ( $obj->adresse ?? '' ) }}"  />
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <select class="custom-select my-2" name="sitMat" id="sitMat">
            ...
            <div class="form-group row">
                ...
                <input class="form-control my-2" name="child" id="child" type="number" min="0" max="40" value="{{ old('value') ?? ( $obj->enfants ?? '' ) }}" />
            </div>
            <div class="form-group row">
                <label class="small mb-1" for="login">Fonction<span class="text-danger" style="font-size:20px;">&nbsp;</span></label>
                <input class="form-control my-2" name="work" id="work" type="text" value="{{ old('value') ?? ( $obj->fonction ?? '' ) }}" />
            </div>
            <div class="form-group row">
                <label class="small mb-1" for="login">Lieu de travail<span class="text-danger" style="font-size:20px;">&nbsp;</span></label>
                <input class="form-control my-2" name="workplace" id="workplace" type="text" value="{{ old('value') ?? ( $obj->lieu_travail ?? '' ) }}" />
            </div>
        </div>
    </div>
    <div class="card bg-primary text-white mb-4">
        <div class="card-body" style="margin:10px;">
            ...
            <div class="form-group row">
                ...
                <input class="form-control @error('email') is-invalid @enderror my-2" name="email" id="email" type="email" value="{{ old('value') ?? ( $obj->email ?? '' ) }}" />
                @error('email')
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group row">
                ...
                <input class="form-control @error('contact') is-invalid @enderror my-2" name="contact" id="contact" type="text" value="{{ old('value') ?? ( $obj->contact ?? '' ) }}" />
                @error('contact')
                    <div class="invalid-feedback">
            ...
            <div class="form-group row">
                ...
                <select class="custom-select @error('opt') is-invalid @enderror my-2" data-dependent="mat" name="opt" id="opt" {{ ( $obj->email ?? '' ) ? 'disabled' : '' }}>
                    <option value='0' selected >Choisir option</option>
                    @foreach($options as $opts)
                        <option value="{{ $opts->id }}" {{ $opts->id == ( $opt->id ?? '') ? 'selected' : '' }} >{{ $opts->nom }}</option>
                    @endforeach
                </select>
                @error('opt')
                    <div class="invalid-feedback">
            ...
            <div class="form-group row">
                <label class="small mb-1" for="mat">Matiere au choix<span class="text-danger" style="font-size:20px;">*</span></label>
                <select class="custom-select @error('mat') is-invalid @enderror my-2" name="mat" id="mat" {{ ( $obj->email ?? ''  ) ? 'disabled' : '' }}>
                   <option value='0'>Choisir matière</option>
                </select>
                @error('mat')
                    <div class="invalid-feedback">
                        {{ $errors->first('mat') }}
            ...
            <div class="form-group row">
                <label class="small mb-1" for="profil">Selectionner image<span class="text-danger" style="font-size:20px;">*</span></label>
                <input class="form-control @error('image') is-invalid @enderror my-2" type="file" name="image" id="image"  />
            ...
            <div class="form-group row">
                <label class="small mb-1" for="show">Apperçu</label>
                <p class="align-content-center">
                    <img id="previewimage" style="margin-top:30px;display:none;" class="bg-light" />
                </p>
            </div>
        </div>
    </div>
