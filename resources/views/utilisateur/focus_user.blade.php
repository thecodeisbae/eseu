                ...
                <div class="card bg-transparent text-black mb-4">
                    <div class="card-body" style="margin:30px;">
                        ...
                        <div class="form-group row">
                            ...
                            <input class="form-control my-2" name="adresse" id="adresse" type="text"  disabled value="{{ $user->adresse != '' ? $user->adresse : 'Non renseigné' }}" />
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <input class="form-control my-2" name="work" id="work" type="text"  disabled value="{{ $user->fonction != '' ? $user->fonction : 'Non renseigné' }}" />
                        </div>
                        <div class="form-group row">
