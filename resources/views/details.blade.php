                    ...
                    <div class="card bg-transparent text-black mb-4">
                        <div class="card-body" style="margin:40px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <div class="form-group row">
                                        <label class="small mb-1" for="session">Session<span class="text-danger" style="font-size:20px;">*</span></label>
                                        <input class=" bg-success text-light form-control @error('session') is-invalid @enderror my-2" name="session" id="session" type="text"  readonly value="{{ $obj->session }}"  />
                                    </div>
                                    <div class="form-group row">
                                        <label class="small mb-1" for="code">Identifiant<span class="text-danger" style="font-size:20px;">*</span></label>
                                        <input class=" bg-success text-light form-control @error('code') is-invalid @enderror my-2" name="code" id="code" type="text"  readonly value="{{ $obj->identifiant }}"  />
                                    </div>
                                    <div class="form-group row">
                                        <label class="small mb-1" for="opt">Option<span class="text-danger" style="font-size:20px;">*</span></label>
                                        <select class=" bg-success text-light custom-select @error('opt') is-invalid @enderror my-2" data-dependent="mat" name="opt" id="opt" aria-readonly="true">
                                            <option value="{{ $opt->id }}">{{ $opt->nom }}</option>
                                        </select>
                                    </div>
                                    <div class="form-group row">
                                        <label class="small mb-1" for="moy">Moyenne<span class="text-danger" style="font-size:20px;">*</span></label>
                                        <input class="bg-success text-light form-control @error('moy') is-invalid @enderror my-2" name="moy" id="moy" type="text"  readonly value="{{ $obj->moyenne }}"  />
                                    </div>
                                    <div class="form-group row">
                                        <label class="small mb-1" for="nom">Nom<span class="text-danger" style="font-size:20px;">*</span></label>
                                        <input class="bg-success text-light form-control @error('nom') is-invalid @enderror my-2" name="nom" id="nom" type="text" readonly value={{ $obj->nom }}  />
                                    </div>
                                    <div class="form-group row">
                                        <label class="small mb-1" for="prenom">Prenoms<span class="text-danger"  style="font-size:20px;">*</span></label>
                                        <input class="bg-success text-light form-control @error('prenom') is-invalid @enderror my-2" name="prenom" id="prenom" type="text" readonly value={{ $obj->prenoms }} />
                                    </div>
                                    <div class="form-group row">
                                        <label class="small mb-1" for="sexe">Sexe<span class="text-danger"  style="font-size:20px;">*</span></label>
                                        <select onclick="return false;" class="bg-success text-light custom-select my-2 @error('sexe')  is-invalid @enderror" name="sexe" id="sexe" disabled>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input class="bg-success text-light form-control @error('date') is-invalid @enderror my-2" name="date" id="date" type="date" readonly value="{{ $obj->date_naissance }}"/>
                                    </div>
                                    <div class="form-group row">
                                        <label class="small mb-1" for="lieu">Lieu de naissance<span class="text-danger" style="font-size:20px;">&nbsp;</span></label>
                                        <input class="bg-info text-light form-control my-2" name="lieu" id="lieu" type="text" readonly value="{{ $obj->lieu_naissance }}" />
                                    </div>
                                    <div class="form-group row">
                                        <label class="small mb-1" for="login">Adresse<span class="text-danger" style="font-size:20px;">&nbsp;</span></label>
                                        <input class="bg-info text-light form-control my-2" name="adresse" id="adresse" type="text" readonly value="{{ $obj->adresse }}" />
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <select class="bg-info text-light custom-select my-2" name="sitMat" id="sitMat" disabled>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input class="bg-info text-light form-control my-2" name="child" id="child" type="number" min="0" max="40"  readonly value="{{ $obj->enfants }}"  />
                                    </div>
                                    <div class="form-group row">
                                        <label class="small mb-1" for="login">Fonction<span class="text-danger" style="font-size:20px;">&nbsp;</span></label>
                                        <input class="bg-info text-light form-control my-2" name="work" id="work" type="text"  readonly value="{{ $obj->fonction }}"  />
                                    </div>
                                    <div class="form-group row">
                                        <label class="small mb-1" for="login">Lieu de travail<span class="text-danger" style="font-size:20px;">&nbsp;</span></label>
                                        <input class="bg-info text-light form-control my-2" name="workplace" id="workplace" type="text"  readonly value="{{ $obj->lieu_travail }}"  />
                                    </div>
                                    <div class="form-group row">
                                        <label class="small mb-1" for="email">Email<span class="text-danger" style="font-size:20px;">*</span></label>
                                        <input class="bg-success text-light form-control @error('email') is-invalid @enderror my-2" name="email" id="email" type="email"  readonly value="{{ $obj->email }}"  />
                                    </div>
                                    <div class="form-group row">
                                        <label class="small mb-1" for="contact">Contact<span class="text-danger" style="font-size:20px;">*</span></label>
                                        <input class="bg-success text-light form-control @error('email') is-invalid @enderror my-2" name="contact" id="contact" type="text"  readonly value="{{ $obj->contact }}"  />
                                    </div>
                                </div>
                            </div>
                        </div>
