...
<main>
    <div class="container-fluid">
        <h3 class="mt-4">Relevés</h3>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active">Supplements/Relevés</li>
            </ol>
        <div class="card-deck" >
           ...
           <div class="card bg-primary text-light col-12">
               <div class="card-body">
                   ...
                   <hr>
                   <form action="/releves" method="POST" target="_blank" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
            ...
            <form action="/singleReleve" target="_blank" id="apply" method="POST" hidden="true">
                @csrf
